...
import com.wesley.imagemarker.builder.BlackBoardBuilder;
...
public class Main {
	...
	public static void main(String[] args){	    	   
			...
			String targetFilePath = "/data/imagemaker/output/board.jpg";			
			//Templet templet = BookCoverBuilder.build(content,cover,title);
			Templet templet = BlackBoardBuilder.build(content);
